...
public class DynamicDNSActivity extends BaseActivity implements OnCheckedChangeListener {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		MenuItem updateMenuItem = menu.add("更新").setIcon(R.drawable.ic_actionbar_refresh);
		...
		updateMenuItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				...
				((GitServerApplication)((Context)DynamicDNSActivity.this).getApplicationContext()).setUpdateDynDnsTime(System.currentTimeMillis());
				return true;
			}
